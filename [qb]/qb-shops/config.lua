...
Config.Products = {
    ['normal'] = {
        {name = 'tosti',         price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'water_bottle',  price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'kurkakola',     price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'twerks_candy',  price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'snikkel_candy', price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'sandwich',      price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'beer',          price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'whiskey',       price = 0,  amount = 50,   info = {}, type = 'item'},
        {name = 'moneybag',         price = 0,  amount = 50,   info = {}, type = 'item'},
        {name = 'bandage',       price = 0, amount = 50,   info = {}, type = 'item'},
        {name = 'lighter',       price = 0,   amount = 50,   info = {}, type = 'item'},
        {name = 'rolling_paper', price = 0,   amount = 5000, info = {}, type = 'item'},
        {name = 'electronickit', price = 0,   amount = 5000, info = {}, type = 'item'},
        {name = 'trojan_usb', price = 0,   amount = 5000, info = {}, type = 'item'},
        {name = 'drill', price = 0,   amount = 5000, info = {}, type = 'item'},

    },
    ['liquor'] = {
        {name = 'beer',    price = 0,  amount = 50, info = {}, type = 'item'},
        {name = 'whiskey', price = 0, amount = 50, info = {}, type = 'item'},
        {name = 'vodka',   price = 0, amount = 50, info = {}, type = 'item'},
    },
    ['hardware'] = {
        {name = 'lockpick',          price = 0, amount = 50,  info = {}, type = 'item'},
        {name = 'weapon_wrench',     price = 0, amount = 250, info = {}, type = 'item'},
        {name = 'weapon_hammer',     price = 0, amount = 250, info = {}, type = 'item'},
        {name = 'repairkit',         price = 0, amount = 50,  info = {}, type = 'item', requiredJob  = { 'mechanic', 'police' }},
        {name = 'screwdriverset',    price = 0, amount = 50,  info = {}, type = 'item'},
        {name = 'phone',             price = 0, amount = 50,  info = {}, type = 'item'},
        {name = 'radio',             price = 0, amount = 50,  info = {}, type = 'item'},
        {name = 'binoculars',        price = 0,  amount = 50,  info = {}, type = 'item'},
        {name = 'firework1',         price = 0,  amount = 50,  info = {}, type = 'item'},
        {name = 'firework2',         price = 0,  amount = 50,  info = {}, type = 'item'},
        {name = 'firework3',         price = 0,  amount = 50,  info = {}, type = 'item'},
        {name = 'firework4',         price = 0,  amount = 50,  info = {}, type = 'item'},
        {name = 'fitbit',            price = 0, amount = 150, info = {}, type = 'item'},
        {name = 'cleaningkit',       price = 0, amount = 150, info = {}, type = 'item'},
        {name = 'advancedrepairkit', price = 0, amount = 50,  info = {}, type = 'item', requiredJob = { 'mechanic' }},
    },
    ['weedshop'] = {
        {name = 'joint',          price = 0,  amount = 50,   info = {}, type = 'item'},
        {name = 'weapon_poolcue', price = 0, amount = 50,   info = {}, type = 'item'},
        {name = 'weed_nutrition', price = 0,  amount = 50,   info = {}, type = 'item'},
        {name = 'empty_weed_bag', price = 0,   amount = 1000, info = {}, type = 'item'},
        {name = 'rolling_paper',  price = 0,   amount = 1000, info = {}, type = 'item'},
    },
    ['gearshop'] = {
        {name = 'diving_gear', price = 0, amount = 10, info = {}, type = 'item'},
        {name = 'jerry_can',   price = 0,  amount = 50, info = {}, type = 'item'},
    },
    ['leisureshop'] = {
        {name = 'parachute',   price = 0, amount = 10, info = {}, type = 'item'},
        {name = 'binoculars',  price = 0,   amount = 50, info = {}, type = 'item'},
        {name = 'diving_gear', price = 0, amount = 10, info = {}, type = 'item'},
        {name = 'diving_fill', price = 0,  amount = 10, info = {}, type = 'item'},
    },
    ['weapons'] = {
        {name = 'weapon_knife',         price = 0,  amount = 250, info = {}, type = 'weapon'},
        {name = 'weapon_bat',           price = 0,  amount = 250, info = {}, type = 'weapon'},
        {name = 'weapon_hatchet',       price = 0,  amount = 250, info = {}, type = 'weapon'},
        {name = 'pistol_ammo',          price = 0,  amount = 250, info = {}, type = 'item',   requiredLicense = { 'weapon' }},
        {name = 'weapon_pistol',        price = 0, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
        {name = 'weapon_snspistol',     price = 0, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
        {name = 'weapon_vintagepistol', price = 0, amount = 5,   info = {}, type = 'weapon', requiredLicense = { 'weapon' }},
    },
    ['casino'] = {
        {name = 'casinochips', price = 0, amount = 999999, info = {}, type = 'item'}
    },
}
